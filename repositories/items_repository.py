...
class ItemsRepository(BaseRepository):
    ...
    def save_item(self, item: Dict[str, Any]) -> Tuple[int, bool, bool]:
        ...
        data = {
            ...
            "parsed_release_json": item.get("parsed_release_json") or "",
            ...
            "tmdb_match_debug": item.get("tmdb_match_debug") or "",
    ...
    def _archive_item_locked(
        ...
        self.conn.execute(
            ...
            INSERT INTO items_archive(
                ...
                source_audio_tracks, imdb_id, cleaned_title, parsed_release_json, source_category_id, source_category_name, tmdb_id, tmdb_title, tmdb_original_title,
            ...
            (
                ...
                full_item.get("parsed_release_json") or "",
